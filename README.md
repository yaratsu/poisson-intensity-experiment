...
By default, the DNN architecture follows the paper's theoretical scaling, normalized at `n_ref=1000`. For sample size `n` and squared-Hellinger rate exponent `gamma`, the runner uses

```text
depth = ceil(3 * log(n) / log(1000)),
